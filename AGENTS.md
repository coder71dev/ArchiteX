...
This project is indexed by GitNexus as **ArchiteX** (685 symbols, 920 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ArchiteX/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ArchiteX/clusters` | All functional areas |
| `gitnexus://repo/ArchiteX/processes` | All execution flows |
| `gitnexus://repo/ArchiteX/process/{name}` | Step-by-step execution trace |
